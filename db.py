...
uri = "mongodb+srv://amit:amit@cluster0.vwqjpev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
frame_nmr = 0
vehicles = [2, 3, 7, 5]
skip_frames = 1  # Adjust this value as needed, it determines how many frames to skip
ret = True
while ret and frame_nmr < 1200:
        ...
        for license_plate in license_plates.boxes.data.tolist():
            ...
            if car_id != -1:
                ...
                if license_plate_text is not None:
                    ...
                    location = "28°38'00.3N 77°13'13.4E"  # replace with actual location
                    ...
                    highest_scores[car_id]['timestamp'] = system_time
                    print(highest_scores[car_id].keys())
    ...
    if frame_nmr % (10 * 3) == 0:
        ...
        for car_id, data in highest_scores.items():
            ...
            print("Frame Number: {}, Car ID: {}".format(frame_nmr, car_id))
            print("\tLicense Plate Text: {}".format(data['text']))
